                        ...
                        <div class="body">
                           <fieldset>
                              ...
                              <div class="row clearfix">
                                 ...
                                 <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 form-control-label">
                                    <input type="text" name="anggota_kd" class="anggota_typeahead form-control"
                                       placeholder="Masukkan Nomor Anggota" id="member_id">
                                 </div>
                              </div>
                              -->
