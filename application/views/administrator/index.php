...
<body class="theme-green">
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?php if ($this->uri->segment(1) == 'collection' || $this->uri->segment(1) == 'genre' || $this->uri->segment(1) == 'author' || $this->uri->segment(1) == 'publisher') : echo "active";
                                endif; ?>">
                        ...
                        <ul class="ml-menu">
                            <li class="<?php if ($this->uri->segment(1) == 'collection') : echo "active";
                                        endif; ?>">
                                <a href="<?php echo site_url('collection') ?>">Master Koleksi</a>
                            </li>
                            <li class="<?php if ($this->uri->segment(1) == 'genre') : echo "active";
                                        endif; ?>">
                                <a href="<?php echo site_url('genre') ?>">Master Genre</a>
                            </li>

                            <li class="<?php if ($this->uri->segment(1) == 'author') : echo "active";
                                        endif; ?>">
                                <a href="<?php echo site_url('author') ?>">Master Penulis</a>
                            </li>

                            <li class="<?php if ($this->uri->segment(1) == 'publisher') : echo "active";
                                        endif; ?>">
                                <a href="<?php echo site_url('publisher') ?>">Master Penerbit</a>
                            </li>
                        </ul>
                    </li>
                    <li class="<?php if ($this->uri->segment(1) == 'circulation') : echo "active";
                                endif; ?>">
                        <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            <li class="<?php if ($this->uri->segment(2) == 'choose_member') : echo "active";
                                        endif; ?>">
                                <a href="<?php echo site_url('circulation/choose_member') ?>">Peminjaman</a>
                            </li>
                            <li class="<?php if ($this->uri->segment(2) == 'returnbook') : echo "active";
                                        endif; ?>">
    ...
    <script>
        ...
        $("#upload_image").fileinput({
            ...
            layoutTemplates: {
                main2: '{preview} ' + '<div style="text-align:center;padding-bottom:30px">' + ' {remove} {browse}' + '</div>'
            },
