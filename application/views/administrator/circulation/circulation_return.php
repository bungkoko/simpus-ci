                                  ...
                                  <fieldset>
                                      ...
                                      <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                                          <div class="input-group">
                                              ...
                                              <div class="form-line">
                                                  <input type="text" name="sirkulasi_pinjam_kd" class="form-control" id="sirkulasi_pinjam_kd" placeholder="Masukkan Kode Transaksi" value=<?php echo $this->input->post('sirkulasi_pinjam_kd') ?>>
                                              </div>
                                          </div>
                                      </div>
                                  ...
                                  <?php if (!empty($member)) : ?>
                                      ...
                                      <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                          <div class="input-group">
                                              ...
                                              <div class="form-line">
                                                  <input type="text" name="anggota_kd" class="form-control" placeholder="Otomatis terisi ketika kode transaksi terisi" value="<?php echo $member->anggota_kd; ?>" readonly>
                                              </div>
                                              <span id="notif"></span>
                                          </div>
                                      </div>
                                  ...
                                  <?php else : ?>
                                      ...
                                      <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                          <div class="input-group">
                                              <span class="input-group-addon">Nama Anggota</span>
                                              <div class="form-line">
                                                  <input type="text" name="anggota_nm" class="form-control" id="member_nm" placeholder="Otomatis terisi ketika kode transaksi terisi" readonly>
                                              </div>
                                          </div>
                                      </div>
                                  <?php endif; ?>
                                      ...
                                      <tbody>
                                          <?php
                                            ...
                                            ?>
                                              ...
                                              <tr>
                                                  <td colspan="10">
                                                      <center>Belum Ada Data / Tidak ada Data</center>
                                                  </td>
                                              </tr>
                                          <?php endif; ?>
                                      </tbody>
